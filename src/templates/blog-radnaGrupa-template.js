   ...
   <section className={styles.blog}>
    <div className={styles.center}>
     ...
     <div className={styles.allBlogsButton}>
      <AniLink fade to='/radnaGrupaZaBiomasu' className='btn-primary'>
       svi clanci
      </AniLink>
     </div>
    </div>
...
export const query = graphql`
         query getPostRadnaGrupa($slug: String!) {
           post: contentfulRadnaGrupaPost(slug: { eq: $slug }) {
             title
