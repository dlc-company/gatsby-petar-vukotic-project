  ...
  <Layout>
   ...
   <Menu items={data.menu} />
    <div className={styles.title}>
       <Title title='vodič za finansiranje' subtitle='bioenergetskih projekata'/>
    </div>
      ...
      <div className={styles.aboutCenter}>
        <article className={styles.aboutInfo}>
          ...
          <ul>
            ...
            <li>
               SIPRU vodič – ovaj vodič je jedna od obuhvatnijih lista svih donatora u Srbiji, i u njemu svako može da pronađe nešto za sebe. Dostupan je na adresi <a href="http://www.socijalnoukljucivanje.gov.rs/vodic/vodic2015.html" target="_blank">
                 socijalnoukljucivanje.gov.rs/vodic/vodic2015
                 </a>.
            </li>
            <li>
               Vodič kroz potencijalne izvore finansiranja Građanskih inicijativa – dostupan na adresi <a href="https://vodic.gradjanske.org/" target="_blank">
            ...
            <li>
               ...
               <br/><a href="https://www.civilnodrustvo.gov.rs" target="_blank">
                 Pogledati za više.
               </a>
            </li>
            <li>
               ...
               <br/><a href="https://www.mei.gov.rs/" target="_blank">
                 Pogledati za više.
                 </a> 
            </li>
          </ul>
